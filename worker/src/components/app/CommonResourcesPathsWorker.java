...
public class CommonResourcesPathsWorker {

    // main components
    public final static String LOGIN_RESOURCE = "/components/login/loginWorker.fxml";
    ...
    public final static String TASK_INC_MSG_fXML_RESOURCE = "/components/graphManager/task/simulation/incrementalError/incrementalError.fxml";
    public final static String TASK_SIM_RES_MSG_fXML_RESOURCE = "/components/graphManager/task/simulation/result/result.fxml";
    public final static String TASK_COMP_RES_MSG_fXML_RESOURCE = "/components/graphManager/task/compilation/result/compResult.fxml";
    public final static String TASK_MORE_INFO_MSG_fXML_RESOURCE = "/components/graphManager/task/moreInfo/moreInfo.fxml";
